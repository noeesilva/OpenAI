...
--
-- Table structure for table `layoff`
--
...
CREATE TABLE `layoff` (
  ...
  `reported_layoff` text DEFAULT NULL,
...
--
-- Dumping data for table `layoff`
--

LOCK TABLES `layoff` WRITE;
/*!40000 ALTER TABLE `layoff` DISABLE KEYS */;
/*!40000 ALTER TABLE `layoff` ENABLE KEYS */;
UNLOCK TABLES;
